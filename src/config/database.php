 ...
 * $pdo = Database::conexao(); // Pega a instância da conexao com o banco de dados.
 * $insercao = $pdo->prepare("INSERT INTO pessoa (nome, idade) VALUES (:nome, :idade)"); // Prepara a instrução de inserção de uma pessoa no banco de dados.
